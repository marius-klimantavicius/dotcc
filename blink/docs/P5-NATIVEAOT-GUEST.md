...
health/stop HTTP responses and normal exit in raw/optimized JIT/NativeAOT,
with all four workers joined and backing released. Final product/worker/sample
integration and ordinary controller stop remain pending. Registrations remain explicitly unsupported; stable
