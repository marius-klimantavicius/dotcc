...
Status: **I0–I2 complete for Linux x64**, with final evidence in
[VALIDATION.md](VALIDATION.md). P7 and other platforms remain separate.
...
- [x] I0: immutable public options and worker serialization; bounded listener;
...
- [x] I1: guest socket protocol/lifecycle checks and a real AWS SDK NativeAOT guest;
...
- [x] I2: usage documentation and evidence ledger. Commit final milestone.
