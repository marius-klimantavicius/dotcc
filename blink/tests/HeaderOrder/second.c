...
#include <stdio.h>
int Second(void) {
  struct linger host = {1, 23};
  struct linger_linux guest = {{1, 0, 0, 0}, {9, 0, 0, 0}};
  printf("second host=%zu/%zu/%zu/%zu guest=%zu/%zu/%zu/%zu values=%d/%u\n",
  ...
  printf("second placement=%td/%td fields=%td/%td\n",
  ...
  return host.l_linger != 23 || guest.linger[0] != 9;
}
