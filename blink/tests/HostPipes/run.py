...
try:
    ...
    shutil.copyfile(ROOT/'src/Host/HostPipesBridge.cs',a/'HostPipesBridge.cs')
    ...
    shutil.copyfile(ROOT/'src/Host/include/host-pipes.h',a/'profile/host-pipes.h')
    shutil.copyfile(ROOT/'src/Host/HostReadinessBridge.cs',a/'HostReadinessBridge.cs')
