...
Native Linux and the separately built pinned threaded Blink passed the valid fixture. The managed harness is source-only and awaits a passing threaded delivery plus execution release; no C# threaded-owner or translated-runtime pass is claimed.
