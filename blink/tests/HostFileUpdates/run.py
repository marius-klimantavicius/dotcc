...
try:
    ...
    shutil.copyfile(ROOT/'src/Host/HostFileUpdatesBridge.cs',a/'HostFileUpdatesBridge.cs')
    shutil.copyfile(ROOT/'src/Host/include/host-file-updates.h',a/'profile/host-file-updates.h')
