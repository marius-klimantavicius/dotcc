...
try:
    ...
    shutil.copyfile(ROOT/'src/Host/HostDescriptorsBridge.cs',a/'HostDescriptorsBridge.cs')
    shutil.copyfile(ROOT/'src/Host/include/host-descriptors.h',a/'profile/host-descriptors.h')
