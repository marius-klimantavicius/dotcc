...
#endif
{
    ...
    public static void BindHostSleep(HostSleep value, CancellationToken cancellation)
    {
    ...
    public static void UnbindHostSleep() { sleepOwner = null; sleepCancellation = default; }
    ...
    public static unsafe int blink_host_nanosleep(Libc.timespec* request, Libc.timespec* remaining)
    {
        ...
        var result = sleepOwner.Sleep(request->tv_sec, request->tv_nsec, sleepCancellation);
