...
def adapt(predecessor, memory):
    ...
    before = {"syscall.c": predecessor, "memorymalloc.c": memory}
...
def main():
    ...
    outputs = [args.output / name for name in ("syscall.c", "memorymalloc.c", "guest-threads.patch")]
    ...
    staged, patch = adapt(predecessor, memory)
    ...
    payloads = [staged["syscall.c"], staged["memorymalloc.c"], patch, overlays["pthread.h"], overlays["signal.h"],
