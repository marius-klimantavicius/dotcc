...
static const char *const corpus[] = {
  ...
  "SELECT json('{broken');",
  "CREATE VIRTUAL TABLE enabled_fts USING fts5(content); INSERT INTO enabled_fts VALUES('quick brown fox'); SELECT rowid FROM enabled_fts WHERE enabled_fts MATCH 'brown'; DROP TABLE enabled_fts;",
  "CREATE VIRTUAL TABLE forbidden_fts3 USING fts3(content);",
  "CREATE VIRTUAL TABLE forbidden_fts4 USING fts4(content);",
