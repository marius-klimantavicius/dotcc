...
internal unsafe class MsQuicSafeHandle : SafeHandle
{
    ...
    private readonly delegate* <MsQuic.QUIC_HANDLE*, void> _releaseAction;
    private string? _traceId;
    private readonly SafeHandleType _type;

    public override bool IsInvalid => handle == IntPtr.Zero;

    public MsQuic.QUIC_HANDLE* QuicHandle => (MsQuic.QUIC_HANDLE*)DangerousGetHandle();

    public MsQuicSafeHandle(MsQuic.QUIC_HANDLE* handle, delegate* <MsQuic.QUIC_HANDLE*, void> releaseAction, SafeHandleType safeHandleType)
    ...
    public MsQuicSafeHandle(MsQuic.QUIC_HANDLE* handle, SafeHandleType safeHandleType)
        : this(
            handle,
    ...
    {
        MsQuic.QUIC_HANDLE* quicHandle = QuicHandle;
...
internal sealed class MsQuicContextSafeHandle : MsQuicSafeHandle
{
    ...
    public unsafe MsQuicContextSafeHandle(MsQuic.QUIC_HANDLE* handle, GCHandle context, SafeHandleType safeHandleType, MsQuicSafeHandle? parent = null)
...
internal sealed class MsQuicConfigurationSafeHandle : MsQuicSafeHandle, ISafeHandleCachable
{
    ...
    public unsafe MsQuicConfigurationSafeHandle(MsQuic.QUIC_HANDLE* handle)
