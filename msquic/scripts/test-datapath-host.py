...
try:
 ...
 for variant in args.variants:
  ...
  generated=ROOT/'generated'/('TranslatedMsQuic.Raw' if variant == 'raw' else 'TranslatedMsQuic');library=generated/'TranslatedMsQuic.csproj'
 ...
 if receipt['source_hashes']!={str(p.relative_to(ROOT)):sha(p) for p in sourcefiles}:policy().issue('Host sources changed during validation')
 receipt['passed']=True
