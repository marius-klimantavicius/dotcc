    ...
    for case, source in [('binding', ROOT / 'tests/HostContract/binding.c'),
        ...
        if case == 'core':
            ...
            for index, input_path in enumerate(inputs):
                ...
                run(['dotnet', str(compiler / 'dotcc.dll'), '--emit=obj', *flags, *includes,
                ...
                object_receipt = dict(source=input_path,
                    ...
                    compiler_hashes=receipt['compiler_hashes'], flags=flags, includes=includes,
            ...
            run(['dotnet', str(compiler / 'dotcc.dll'), '--emit=csproj', *flags, *includes,
