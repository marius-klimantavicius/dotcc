...
| Plan | Status |
|---|---|
| [c-macro-overrides-intrinsics](c-macro-overrides-intrinsics.md) | **COMPLETE — M0–M3** (2026-09-11). Generic name/exact/regex macro overrides, formal/capture templates, CLI/dependencies/object provenance, typed BCL endian intrinsic and SQLite profile. 2,094 unit / 387 functional tests pass (969 opt-in skips); NativeAOT compiler and generated fixture, raw/postprocessed SQLite consumer, UTF16 native exchange, JIT/AOT WAL recovery/interoperability and product layout pass. Linux x64 evidence. Subsequent [semantic function overrides](../function-overrides.md) and [external type registration](../external-types.md) shipped in `10c2c60`; structural body recognition remains separate. |
