...
| Plan | Status |
|---|---|
| [c-macro-overrides-intrinsics](c-macro-overrides-intrinsics.md) | **IN PROGRESS** (2026-09-11). Macro configuration, exact/regex matching, templates, CLI and preprocessing implemented. Generic C macro profiles with optional exact/regex body selectors, named captures and formal-parameter templates, plus a typed runtime endianness intrinsic; SQLite configuration maps endian macros to BCL access. Remaining: M0 contract, M1 preprocessing rules, M2 typed lowering, M3 SQLite integration/validation. |
