...
| Plan | Status |
|---|---|
| [c-macro-overrides-intrinsics](c-macro-overrides-intrinsics.md) | **IN PROGRESS** (2026-09-11). M0–M2 macro overrides, regex/formal templates, CLI/dependencies/object provenance and typed runtime endianness implemented. Full compiler suites and NativeAOT compiler/profile probe pass. SQLite raw regeneration/consumer pass; postprocessed UTF16/native/AOT, WAL and layout validation underway. |
