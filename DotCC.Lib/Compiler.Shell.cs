...
public static partial class Compiler
{
    ...
    /// <paramref name="managedLibrary"/> instead produces an ordinary managed
    /// class library, suitable for a C# project reference, without native exports.
    /// </summary>
    public static string BuildGeneratedCsproj(
        ...
        bool managedLibrary = false, string? namespaceName = null)
    {
        var rootNamespace = ResolveNamespace(namespaceName, EmitMode.Csproj)?.Replace("@", "") ?? "DotCCGenerated";
        ...
        return $"""
            <Project Sdk="Microsoft.NET.Sdk">
              <!-- Generated by dotcc. -->
              <PropertyGroup>
                <OutputType>{(managedLibrary ? "Library" : "Exe")}</OutputType>
                <TargetFramework>net10.0</TargetFramework>
                <RootNamespace>{rootNamespace}</RootNamespace>
                <AssemblyName>{assemblyName}</AssemblyName>
                <AllowUnsafeBlocks>true</AllowUnsafeBlocks>
        ...
        IReadOnlyList<(string Name, string FnName)>? tests = null, string libraryClass = "DotCcLib", bool partial = false, string? namespaceName = null, bool nested = false, bool includeZig = true)
    {
        ...
        return $$"""
            ...
            // </auto-generated>
            {{GeneratedTypesWarningPragma}}{{NamespaceDeclaration(namespaceName)}}using System;
    ...
    /// <summary>
    /// Library-mode shell. Managed libraries expose <c>public static class DotCcLib</c>
    /// directly. Native shared libraries keep it internal and emit <c>DotCcExports</c> with
        ...
        bool importsAreStatic = false, bool managedLibrary = false, string libraryClass = "DotCcLib", bool partial = false, string? namespaceName = null, bool nested = false, bool includeZig = true)
    {
        ...
        var modeDescription = managedLibrary ? "Managed library with explicit C# callback registration." : "NativeAOT shared library with C-ABI exports.";
        return $$"""
            //!dotcc program 1 — generated by dotcc (transpiled C → C#, library)
            // <auto-generated>
            // Emitted by dotcc from c.lalr.yaml + the input translation units.
            // {{modeDescription}}
            // </auto-generated>
