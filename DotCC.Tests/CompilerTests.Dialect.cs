...
public sealed partial class CompilerTests
{
    ...
    [InlineData("int main() { _Static_assert(1, \"ok\"); return 0; }", "c99", "_Static_assert", "C11")]
    [InlineData("_Static_assert(1);\nint main() { return 0; }", "c17", "_Static_assert with no message", "C23")]
